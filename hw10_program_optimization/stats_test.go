...
func TestGetDomainStat(t *testing.T) {
	...
	data2 := `{"Id":1,"Name":"Howard Mendoza","Username":"0Oliver","Email":"aliquid_qui_ea@сбд.рос","Phone":"6-866-899-36-79","Password":"InAQJvsq","Address":"Blackbird Place 25"}
			  {"Id":2,"Name":"Jesse Vasquez","Username":"qRichardson","Email":"mLynch@сбд.рос","Phone":"6-866-899-36-79","Password":"InAQJvsq","Address":"Blackbird Place 25"}
			  {"Id":3,"Name":"Clarence Olson","Username":"RachelAdams","Email":"админ@сбдбп.рос","Phone":"6-866-899-36-79","Password":"InAQJvsq","Address":"Blackbird Place 25"}`
	...
	data8 := `{"Id":1,"Name":"Howard Mendoza","Username":"0Oliver","Email":"aliquid","Phone":"6-866-899-36-79","Password":"InAQJvsq","Address":"Blackbird Place 25"}
			  {"Id":2,"Name":"Jesse Vasquez","Username":"qRichardson","Email":"mLynch@browsecat.com","Phone":"9-373-949-64-00","Password":"SiZLeNSGn","Address":"Fulton Hill 80"}
			  {"Id":3,"Name":"Clarence Olson","Username":"RachelAdams","Email":"aliquid2.com","Phone":"988-48-97","Password":"71kuz3gA5w","Address":"Monterey Park 39"}`
	...
	t.Run("find cyrillic 'ру'", func(t *testing.T) {
		result, err := GetDomainStat(bytes.NewBufferString(data2), "рос")
		require.NoError(t, err)
		require.Equal(t, DomainStat{
			"сбд.рос":   2,
			"сбдбп.рос": 1,
	...
	t.Run("getting error invalid email", func(t *testing.T) {
		_, err := GetDomainStat(bytes.NewBufferString(data8), "com")
		require.Error(t, err)
		require.Equal(t, "invalid email: aliquid2.com", err.Error())
	})
}
